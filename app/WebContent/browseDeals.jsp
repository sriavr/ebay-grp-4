...
<div class="row">
	<div class="lefthand-sidebar large-3 columns">
		<div class="categories-box">
			...
			<ul class="side-nav">
				<s:iterator value="categories" var="parent">
					<li class="category-box"><s:url action="browsedeals.action"
							var="urlTag">
						...
						<ul>
							<s:iterator var="child" value="#parent.categories">
								<li><s:url action="browsedeals.action" var="urlTag">
		...
		<s:form action="browsedeals.action" id="browseForm" method="get"
			theme="simple">
			<div class="price-box">
				<h4>Price Range</h4>
			...
			<div class="row padding-4">
				...
				<div class="large-6 columns">
					...
					<s:property value="productId" />
						...
						class="<s:if test="dealsId!=0">discount</s:if>"> Price: Rs.
							<s:property value="price" />
					</span></b>
					<s:if test="dealsId!=0">
						<br />
						<span style="font-size: 1.2em;font-weight:bold;"> Discounted Price: Rs. <s:property
								value="dealSellingPrice" />
						</span>
						<br />
						Offer valid till: <s:property value="dealEndDate" />
					</s:if>
