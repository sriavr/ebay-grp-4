...
<script type="text/javascript">
	function editCart_BuyLinks() {
		...
		if (((quantity - max_quantiy) > 0) || (quantity == 0)) {
	...
	<div class="row">
		<div class="columns large-8">
			...
			<b>Quantity:</b> <input type="text" name="quantity"
				onkeyup="editCart_BuyLinks()" id="quantity"
				style="width: 30px; display: inline;" value="1" />
			...
			<hr />
			<span class="<s:if test="product.dealsId!=0">discount</s:if>" style="font-weight:bold;font-size:1.2em;">Price:
				Rs. <s:property value="product.price"></s:property>
			</span> &nbsp; &nbsp;
			<s:if test="product.dealsId!=0">
				<span style="font-weight:bold;font-size:1.2em;"> After Discount: Rs. <s:property
						value="product.dealSellingPrice" />
				</span>
				<br />
